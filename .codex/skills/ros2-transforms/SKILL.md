...
description: Use when implementing TF2 transform lookup/broadcast patterns in ROS2 Humble without leaking ROS types into domain.
---
...
Implement Python TF2 wrappers using Humble tf2 tutorials and keep conversion to domain pose/value objects inside infrastructure services.
