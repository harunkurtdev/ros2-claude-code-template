---
name: ros2-bag
description: Use when creating ROS2 bag recording, playback, or analysis workflows with rosbag2 in Humble.
---
...
Use the Humble rosbag2 tutorials and API docs as baseline, then adapt into infrastructure adapters so domain/application layers stay ROS-agnostic.
